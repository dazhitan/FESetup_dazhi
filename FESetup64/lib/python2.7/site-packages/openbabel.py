...
class OBAtomHOF(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _openbabel.OBAtomHOF_swiginit(self,_openbabel.new_OBAtomHOF(*args))
...
OBAtom.IsSulfoneOxygen = new_instancemethod(_openbabel.OBAtom_IsSulfoneOxygen,None,OBAtom)
...
def ImplicitRefToStereo(*args):
  return _openbabel.ImplicitRefToStereo(*args)
...
_OBMolAtomIter.IsSulfoneOxygen = new_instancemethod(_openbabel._OBMolAtomIter_IsSulfoneOxygen,None,_OBMolAtomIter)
...
_OBMolAtomDFSIter.IsSulfoneOxygen = new_instancemethod(_openbabel._OBMolAtomDFSIter_IsSulfoneOxygen,None,_OBMolAtomDFSIter)
...
_OBMolAtomBFSIter.IsSulfoneOxygen = new_instancemethod(_openbabel._OBMolAtomBFSIter_IsSulfoneOxygen,None,_OBMolAtomBFSIter)
...
_OBAtomAtomIter.IsSulfoneOxygen = new_instancemethod(_openbabel._OBAtomAtomIter_IsSulfoneOxygen,None,_OBAtomAtomIter)
...
_OBResidueAtomIter.IsSulfoneOxygen = new_instancemethod(_openbabel._OBResidueAtomIter_IsSulfoneOxygen,None,_OBResidueAtomIter)
